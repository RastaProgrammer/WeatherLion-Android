 ...
 * @link https://stackoverflow.com/a/31734500
...
@SuppressWarnings({"unused", "WeakAccess"})
public class HttpRequest
{
    ...
    //Can be instantiated with String representation of url, force caller to check for
    // IOException which can be thrown
